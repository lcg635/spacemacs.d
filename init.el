...
(defun dotspacemacs/user-init ()
  ...
  (add-hook 'go-mode-hook 'evil-mc-mode)
  )
...
(defun dotspacemacs/user-config ()
  ...
  (global-set-key (kbd "s-m") 'go-import-add)
  )
